public class Peaklass {
    public static void main(String[] args) {
        ...
        System.out.println("""
                ...
                reaks ja 0-st 9-ni veeruks, kus 0,0 tähistab vasakut ülemist välja. Laevad on märgitud numbritega, mis näitavad laeva
                pikkust. Saate pommitada kuni eksite ja siis tuleb arvuti kord.
                Näete, kuhu arvuti pommitas iga tema korra järel. Samuti näete lauda, kus kõik teie pommitamised kirjas. Kui lasete ise või arvuti laseb laeva põhja, tuleb selle kohta sõnum
